                            ...
                            <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="nom" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200" type="text" name="nom" :value="old('nom', $employee->nom)" required autofocus />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="prenom" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200" type="text" name="prenom" :value="old('prenom', $employee->prenom)" required />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="age" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200" type="number" name="age" :value="old('age', $employee->age)" required min="18" max="100" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="zone_rurale" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200" type="text" name="zone_rurale" :value="old('zone_rurale', $employee->zone_rurale)" required />
                            ...
                            <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="experience_annees" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200" type="number" name="experience_annees" :value="old('experience_annees', $employee->experience_annees)" required min="0" />
