        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg rounded-lg border border-gray-200">
                <div class="p-6 text-gray-900">
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-100 shadow-sm">
                        <div class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4 w-full md:w-auto">
                            <div class="w-full md:w-auto">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="search" placeholder="Nom ou prénom" class="pl-10 w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200">
                                </div>
                            </div>
                            <div class="w-full md:w-auto">
                                <label for="filter-disponible" class="block text-sm font-medium text-gray-700 mb-1">Disponibilité</label>
                                <select id="filter-disponible" class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all duration-200">
                        ...
                        <div class="w-full md:w-auto">
                            <a href="{{ route('employees.create') }}" class="w-full md:w-auto inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:from-green-600 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-200 shadow-md transform hover:scale-105">
